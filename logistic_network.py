"""
We will use this class to repesent a simple logistic regression
...
class LogisticNetwork(object):
    ...
    def __init__(self, input, input_dim, output_dim):
        """
        We first initialize the logistic netowrk object with some important info
        ...
        the number of possible classification for the input)
        """
    ...
    def logistic_network_cost(self, y, lambda_l2=0.0001):
        """
